    ...
    Public Class IrcStrings
        ...
        Public Sub LoadCommands()
            Try
                ...
                lCommands.cCount = Convert.ToInt32(IniFileHelper.ReadINI(Modules.lSettings.ReturnCommandsINI, "Settings", "Count", "0"))
                For i = 1 To lCommands.cCount
                    With lCommands.cCommad(i)
                        .cData = IniFileHelper.ReadINI(Modules.lSettings.ReturnCommandsINI, Trim(Str(i)), "Command", "")
                        If Len(.cData) <> 0 Then
                            .cCommandType = CType(IniFileHelper.ReadINI(Modules.lSettings.ReturnCommandsINI, Trim(Str(i)), "Type", ""), IrcCommandTypes)
                            .cDisplay = IniFileHelper.ReadINI(Modules.lSettings.ReturnCommandsINI, Trim(Str(i)), "Display", "")
                            .cParam1 = IniFileHelper.ReadINI(Modules.lSettings.ReturnCommandsINI, Trim(Str(i)), "Param1", "")
                            If Len(.cParam1) <> 0 Then .cParam2 = IniFileHelper.ReadINI(Modules.lSettings.ReturnCommandsINI, Trim(Str(i)), "Param2", "")
                            If Len(.cParam2) <> 0 Then .cParam3 = IniFileHelper.ReadINI(Modules.lSettings.ReturnCommandsINI, Trim(Str(i)), "Param3", "")
                            If Len(.cParam3) <> 0 Then .cParam4 = IniFileHelper.ReadINI(Modules.lSettings.ReturnCommandsINI, Trim(Str(i)), "Param4", "")
                        End If
                    End With
                Next i
            Catch ex As Exception
