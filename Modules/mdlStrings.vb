...
Module mdlStrings
    ...
    Public Sub ProcessReplaceCommand(ByVal lStatusIndex As Integer, ByVal lType As eCommandTypes, Optional ByVal p1 As String = "", Optional ByVal p2 As String = "", Optional ByVal p3 As String = "", Optional ByVal p4 As String = "")
        ...
        Catch ex As Exception
            ProcessError(ex.Message, "Public Sub ProcessReplaceCommand(ByVal lStatusIndex As Integer, ByVal lType As eCommandTypes, Optional ByVal p1 As String = "", Optional ByVal p2 As String = "", Optional ByVal p3 As String = "", Optional ByVal p4 As String = "")")
        End Try
    End Sub
    ...
    Private Function FindCommandIndex(ByVal lType As eCommandTypes) As Integer
        Try
            ...
            Next i
        Catch ex As Exception
            ProcessError(ex.Message, "Private Function FindCommandIndex(ByVal lType As eCommandTypes) As Integer")
        End Try
    End Function
    ...
    Public Function ReturnReplacedCommand(ByVal lType As eCommandTypes, Optional ByVal p1 As String = "", Optional ByVal p2 As String = "", Optional ByVal p3 As String = "", Optional ByVal p4 As String = "") As gCommandReturnData
        Try
            ...
            End If
        Catch ex As Exception
            ProcessError(ex.Message, "Public Function ReturnReplacedCommand(ByVal lType As eCommandTypes, Optional ByVal p1 As String = "", Optional ByVal p2 As String = "", Optional ByVal p3 As String = "", Optional ByVal p4 As String = "") As gCommandReturnData")
            Return Nothing
        End Try
    End Function
    ...
    Public Function DoesColorExist(ByVal lData As String) As Boolean
        Try
            ...
            End If
        Catch ex As Exception
            ProcessError(ex.Message, "Public Function DoesColorExist(ByVal lData As String) As Boolean")
            Return Nothing
        End Try
    End Function
    ...
    Public Sub tDoColor(ByVal lData As String, ByVal lColorTextBox As RichTextBox)
        Try
            ...
            End If
        Catch ex As Exception
            ProcessError(ex.Message, "Public Sub tDoColor(ByVal lData As String, ByVal lColorTextBox As RichTextBox)")
        End Try
    End Sub
    ...
    Public Sub SetSelectionStart(ByVal lColorTextBox As RichTextBox)
        Try
            ...
            lColorTextBox.SelectionStart = 0
        Catch ex As Exception
            ProcessError(ex.Message, "Public Sub SetSelectionStart(ByVal lColorTextBox As RichTextBox)")
        End Try
    End Sub
    ...
    Public Function ConvertIntToSystemColor(ByVal lColor As Integer, Optional lBlackSetting As Boolean = False) As System.Drawing.Color
        Try
            ...
            End Select
        Catch ex As Exception
            ProcessError(ex.Message, "Public Function ConvertIntToSystemColor(ByVal lColor As Integer, Optional lBlackSetting As Boolean = False) As System.Drawing.Color")
            Return Nothing
        End Try
    End Function
    ...
    Public Function ReturnRightColorNumeric(ByVal lData As String) As Integer
        Try
            ...
            End If
        Catch ex As Exception
            ProcessError(ex.Message, "Public Function ReturnRightColorNumeric(ByVal lData As String) As Integer")
            Return Nothing
        End Try
    End Function
    ...
    Public Sub SetStringData(ByVal lIndex As Integer, ByVal lData As String)
        Try
            ...
            End If
        Catch ex As Exception
            ProcessError(ex.Message, "Public Sub SetStringData(ByVal lIndex As Integer, ByVal lData As String)")
        End Try
    End Sub
    ...
    Public Sub SetStringDescription(ByVal lIndex As Integer, ByVal lData As String)
        Try
            ...
            End If
        Catch ex As Exception
            ProcessError(ex.Message, "Public Sub SetStringDescription(ByVal lIndex As Integer, ByVal lData As String)")
        End Try
    End Sub
    ...
    Public Sub SetStringSyntax(ByVal lIndex As Integer, ByVal lData As String)
        Try
            ...
            End If
        Catch ex As Exception
            ProcessError(ex.Message, "Public Sub SetStringSyntax(ByVal lIndex As Integer, ByVal lData As String)")
        End Try
    End Sub
    ...
    Public Sub SetStringSupport(ByVal lIndex As Integer, ByVal lData As String)
        Try
            ...
            End If
        Catch ex As Exception
            ProcessError(ex.Message, "Public Sub SetStringSupport(ByVal lIndex As Integer, ByVal lData As String)")
        End Try
    End Sub
    ...
    Public Sub ResetStrings()
        Try
            ...
            LoadStrings()
        Catch ex As Exception
            ProcessError(ex.Message, "Public Sub ResetStrings()")
        End Try
    End Sub
    ...
    Public Function FindStringIndexByDescription(ByVal lDescription As String) As Integer
        Try
            ...
            End If
        Catch ex As Exception
            ProcessError(ex.Message, "Public Function FindStringIndexByDescription(ByVal lDescription As String) As Integer")
        End Try
    End Function
    ...
    Public Function ReturnStringTypeByDescription(ByVal lDescription As String) As eStringTypes
        Try
            ...
            End If
        Catch ex As Exception
            ProcessError(ex.Message, "Public Function ReturnStringTypeByDescription(ByVal lDescription As String) As eStringTypes")
        End Try
    End Function
    ...
    Public Function ReturnStringCompatibile(ByVal lType As eStringTypes) As Boolean
        Try
            ...
            End With
        Catch ex As Exception
            ProcessError(ex.Message, "Public Function ReturnStringCompatibile(ByVal lType As eStringTypes) As Boolean")
        End Try
    End Function
    ...
    Public Function ReturnReplacedString(ByVal lType As eStringTypes, Optional ByVal r1 As String = "", Optional ByVal r2 As String = "", Optional ByVal r3 As String = "", Optional ByVal r4 As String = "", Optional ByVal r5 As String = "", Optional ByVal r6 As String = "", Optional ByVal r7 As String = "", Optional ByVal r8 As String = "") As String
        ...
        Catch ex As Exception
            ProcessError(ex.Message, "Public Function ReturnReplacedString(ByVal lType As eStringTypes, Optional ByVal r1 As String = "", Optional ByVal r2 As String = "", Optional ByVal r3 As String = "", Optional ByVal r4 As String = "", Optional ByVal r5 As String = "", Optional ByVal r6 As String = "", Optional ByVal r7 As String = "", Optional ByVal r8 As String = "") As String")
            Return Nothing
        End Try
    End Function
    ...
    Public Sub SaveTextStrings()
        Try
            ...
            Next i
        Catch ex As Exception
            ProcessError(ex.Message, "Public Sub SaveTextStrings()")
        End Try
    End Sub
    ...
    Public Function ReturnStringDataByType(ByVal lType As eStringTypes) As String
        ...
        Catch ex As Exception
            ProcessError(ex.Message, "Public Function ReturnStringDataByType(ByVal lType As eStringTypes) As String")
            Return Nothing
        End Try
    End Function
    ...
    Public Sub SetStringData(ByVal lType As eStringTypes, ByVal lData As String)
        Try
            ...
            End If
        Catch ex As Exception
            ProcessError(ex.Message, "Public Sub SetStringData(ByVal lType As eStringTypes, ByVal lData As String)")
        End Try
    End Sub
    ...
    Public Sub ClearStrings()
        Try
            ...
            Next i
        Catch ex As Exception
            ProcessError(ex.Message, "Public Sub ClearStrings()")
        End Try
    End Sub
    ...
    Public Sub LoadCommands()
        Try
            ...
            Next i
        Catch ex As Exception
            ProcessError(ex.Message, "Public Sub LoadCommands()")
        End Try
    End Sub
    ...
    Public Sub LoadStrings()
        Try
            ...
            Next msg
        Catch ex As Exception
            ProcessError(ex.Message, "Public Sub LoadStrings()")
        End Try
    End Sub
    ...
    Public Sub PopulateListViewWithStrings(ByVal lListView As RadListView)
        ...
        Catch ex As Exception
            ProcessError(ex.Message, "Public Sub PopulateListViewWithStrings(ByVal lListView As RadListView)")
        End Try
    End Sub
    ...
    Public Sub DoText(ByVal lData As String, ByVal lTextBox As TextBox)
        ...
        Catch ex As Exception
            ProcessError(ex.Message, "Public Sub DoText(ByVal lData As String, ByVal lTextBox As TextBox)")
        End Try
    End Sub
    ...
    Public Function GetFileTitle(ByVal lFileName As String) As String
        ...
        Catch ex As Exception
            ProcessError(ex.Message, "Public Function GetFileTitle(ByVal lFileName As String) As String")
            Return Nothing
        End Try
    End Function
    ...
    Public Sub Print(data As String, richTextBox As RadRichTextBox)
        ...
        Try
            For i = 0 To Len(data)
                ...
                If msg = "" Then
                    If IsNumeric(Left(data, 2)) = True And Not InStr(Left(data, 2), ",") <> 0 Then
                        foreColor = CInt(Trim(Left(data, 2)))
                        data = Right(data, Len(data) - 2)
                    ElseIf IsNumeric(Left(data, 1)) Then
                        foreColor = CInt(Trim(Left(data, 1)))
                        data = Right(data, Len(data) - 1)
                    Else
                        foreColor = 0
                        backColor = 16
                    ...
                    If Left(data, 1) = "," Then
                        data = Right(data, Len(data) - 1)
                        If IsNumeric(Left(data, 2)) = True And Not InStr(Left(data, 2), ",") <> 0 Then
                            backColor = CInt(Trim(Left(data, 2)))
                            data = Right(data, Len(data) - 2)
                        ElseIf IsNumeric(Left(data, 1)) Then
                            backColor = CInt(Trim(Left(data, 1)))
                            data = Right(data, Len(data) - 1)
                        End If
                    End If
                Else
            ...
            Next i
        Catch ex As Exception
            ProcessError(ex.Message, "Public Sub DoRadColor(data As String, richTextBox As RadRichTextBox)")
        End Try
    End Sub
    ...
    Public Function LeftRight(ByVal lString As String, ByVal lLeft As Integer, ByVal lDistance As Integer) As String
        Try
            ...
            End If
        Catch ex As Exception
            ProcessError(ex.Message, "Public Function LeftRight(ByVal lString As String, ByVal lLeft As Integer, ByVal lDistance As Integer) As String")
            Return Nothing
        End Try
    End Function
    ...
    Public Function ParseData(ByVal lWhole As String, ByVal lStart As String, ByVal lEnd As String) As String
        Try
            ...
            End If
        Catch ex As Exception
            ProcessError(ex.Message, "Public Function ParseData(ByVal lWhole As String, ByVal lStart As String, ByVal lEnd As String) As String")
            Return Nothing
        End Try
    End Function
End Module