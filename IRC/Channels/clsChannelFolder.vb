...
Public Class clsChannelFolderUI
    ...
    Public Sub lstChannels_DoubleClick(_Channel As String, _AutoClose As Boolean)
        ...
        Catch ex As Exception
            Throw 'ProcessError(ex.Message, "Private Sub lstChannels_DoubleClick(ByVal sender As Object, ByVal e As System.EventArgs) Handles lstChannels.DoubleClick")
        End Try
    End Sub
    Public Sub cmdAdd_Click(_Channel As String, _Network As String)
        Try
            ...
            End If
        Catch ex As Exception
            Throw 'ProcessError(ex.Message, "Private Sub cmdAdd_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdAdd.Click")
        End Try
    End Sub
    Public Sub Init()
        Try
    ...
    Public Sub Form_Load()
        ...
        'Catch ex As Exception
        'Throw 'ProcessError(ex.Message, "Private Sub frmChannelFolder_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load")
        'End Try
    End Sub
    Public Sub lstChannels_SelectedIndexChanged()
        ...
        Catch ex As Exception
            Throw 'ProcessError(ex.Message, "Private Sub lstChannels_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles lstChannels.SelectedIndexChanged")
        End Try
    End Sub
    Public Sub cmdRemove_Click(_Channel As String)
        ...
        Catch ex As Exception
            Throw 'ProcessError(ex.Message, "Private Sub cmdRemove_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdRemove.Click")
        End Try
    End Sub
    Private Function ReturnListOfChannels(network As String) As List(Of String)
        ...
        Return channels
        'Catch ex As Exception
        'Throw 'ProcessError(ex.Message, "Private Function ReturnListOfChannels(network As String) As String")
        'Return Nothing
        'End Try
    End Function
    Public Sub cboNetwork_SelectedIndexChanged(_Network As String)
        ...
        Next channel
        'Catch ex As Exception
        'Throw 'ProcessError(ex.Message, "Private Sub cboNetwork_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cboNetwork.SelectedIndexChanged")
        'End Try
    End Sub
    ...
    Public Sub cmdJoin_Click(_Channel As String, _AutoClose As Boolean)
        Try
            ...
            End If
        Catch ex As Exception
            Throw 'ProcessError(ex.Message, "Private Sub cmdJoin_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdJoin.Click")
        End Try
    End Sub
    ...
    Public Sub lnkJumpToChannelList_LinkClicked()
        Try
            ...
            RaiseEvent AnimateClose()
        Catch ex As Exception
            Throw 'ProcessError(ex.Message, "lnkJumpToChannelList_LinkClicked")
        End Try
    End Sub
    Public Sub txtChannel_Enter(_MouseButtons As Windows.Forms.MouseButtons, _Sender As Object)
        ...
        Catch ex As Exception
            Throw 'ProcessError(ex.Message, "Private Sub txtChannel_Enter(sender As Object, e As System.EventArgs) Handles txtChannel.Enter")
        End Try
    End Sub
    Public Sub txtChannel_Leave()
        ...
        Catch ex As Exception
            Throw 'ProcessError(ex.Message, "Private Sub txtChannel_Leave(sender As Object, e As System.EventArgs) Handles txtChannel.Leave")
        End Try
    End Sub
    Private Sub txtChannel_GotFocus(_ChannelTextBox As RadTextBox)
        ...
        Catch ex As Exception
            Throw 'ProcessError(ex.Message, "Private Sub txtChannel_GotFocus(sender As Object, e As System.EventArgs) Handles txtChannel.GotFocus")
        End Try
    End Sub
    Public Sub txtChannel_MouseUp(sender As Object)
        ...
        Catch ex As Exception
            Throw 'ProcessError(ex.Message, "Private Sub txtChannel_MouseUp(sender As Object, e As System.Windows.Forms.MouseEventArgs) Handles txtChannel.MouseUp")
        End Try
    End Sub
End Class
Public Class clsChannelFolder
    ...
    Public Sub Show(_StatusIndex As Integer)
        ...
        Catch ex As Exception
            Throw 'ProcessError(ex.Message, "Public Sub Show(_StatusIndex As Integer)")
        End Try
    End Sub
    ...
    Private Sub SetStatusIndex(_StatusIndex As Integer)
        ...
        Catch ex As Exception
            Throw 'ProcessError(ex.Message, "Public Sub SetStatusIndex(_StatusIndex As Integer)")
        End Try
    End Sub
    Private Sub lWindow_FormClosed(sender As Object, e As System.Windows.Forms.FormClosedEventArgs) Handles lWindow.FormClosed
        Try
            lVisible = False
        Catch ex As Exception
            Throw 'ProcessError(ex.Message, "Private Sub lWindow_FormClosed(sender As Object, e As System.Windows.Forms.FormClosedEventArgs) Handles lWindow.FormClosed")
        End Try
    End Sub
    Public Function Window() As Form
        Try
            Return lWindow
        Catch ex As Exception
            Throw 'ProcessError(ex.Message, "Public Function Window() As Form")
            Return Nothing
        End Try
    End Function
End Class