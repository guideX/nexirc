...
#Region "STATUS"
        Private Sub SocketError(_Error As String, _SocketIndex As Integer)
            lStatusObjects.sStatusObject(_SocketIndex).sWindow.txtIncoming.Print(_Error)
        End Sub
        ...
        Public Sub SetSupportedModes(_StatusIndex As Integer, _Data As String)
            ...
            End With
        End Sub
        Public Function Create(ByVal lIRCSettings As Settings.gIRC, ByVal lServerSettings As ServersModel) As Integer
            ...
            With lStatusObjects.sStatusObject(i)
                ...
                .sWindow.mdiChildWindow.FormType = FormTypes.Status
                ...
                .sPrimitives.sRemoteIP = lSettings.lServers.Servers(lSettings.lServers.Index).Ip
                .sPrimitives.sRemotePort = lSettings.lServers.Servers(lSettings.lServers.Index).Port
                ...
                .sTreeNodeStatus = .sTreeNode.Nodes.Add(lServerSettings.Servers(lServerSettings.Index).Ip, "Status", 0, 0)
                .sTreeNode.Expand()
        ...
        Public Sub SetStatus(ByVal _Index As Integer)
            ...
            SetRemoteSettings(_Index, lSettings.lServers.Servers(lSettings.lServers.Index).Ip, lSettings.lServers.Servers(lSettings.lServers.Index).Port)
            NetworkIndex(_Index) = lSettings.lServers.Servers(lSettings.lServers.Index).NetworkIndex
        ...
        Public Function Find(ByVal _Description As String) As Integer
            ...
            Catch ex As Exception
                Throw 'ProcessError(ex.Message, "Public Function FindStatusWindowIndex(ByVal lDescription As String) As Integer")
                Return Nothing
            End Try
        End Function
        Public ReadOnly Property GetObject(_Index As Integer) As gStatus
            Get
                ...
                Catch ex As Exception
                    Throw 'ProcessError(ex.Message, "Public ReadOnly Property GetObject(_Index As Integer) As gStatus")
                    Return Nothing
                End Try
            End Get
        End Property
        Public Property WindowBarText(ByVal _Index As Integer) As String
            Get
                Try
                    ...
                    End With
                Catch ex As Exception
                    Throw 'ProcessError(ex.Message, "Public Property WindowBarText(ByVal _Index As Integer) As String")
                    Return Nothing
                End Try
            End Get
            Set(ByVal _Value As String)
                Try
                    ...
                    End With
                Catch ex As Exception
                    Throw 'ProcessError(ex.Message, "WindowBarSetting")
                End Try
            End Set
        End Property
        Public Property TreeNodeText(ByVal _Index As Integer) As String
            Get
                Try
                    ...
                    End With
                Catch ex As Exception
                    Throw 'ProcessError(ex.Message, "Public Property TreeNodeText(ByVal _Index As Integer) As String")
                    Return Nothing
                End Try
            End Get
            Set(ByVal _Value As String)
        ...
        Public Property Open(ByVal index As Integer) As Boolean
            ...
            Set(ByVal value As Boolean)
                ...
                Catch ex As Exception
                    Throw 'ProcessError(ex.Message, "Public Property StatusOpen(ByVal _Index As Integer) As Boolean")
                End Try
            End Set
        End Property
        Public Property ServerDescription(ByVal _Index As Integer) As String
            Get
                ...
                Catch ex As Exception
                    Throw 'ProcessError(ex.Message, "Public Property ServerDescription(ByVal _Index As Integer) As String")
                    Return Nothing
                End Try
            End Get
            Set(ByVal _Value As String)
        ...
        Public Property Caption(ByVal _Index As Integer) As String
            Get
                ...
                Catch ex As Exception
                    Throw 'ProcessError(ex.Message, "Public Property StatusCaption(ByVal lIndex As Integer) As String")
                    Return Nothing
                End Try
            End Get
            Set(ByVal _Value As String)
        ...
        Public Property NetworkIndex(ByVal lIndex As Integer) As Integer
            ...
            End Set
        End Property
        Public Property StatusModes(ByVal lIndex As Integer) As ModeModel
            Get
                Return lStatusObjects.sStatusObject(lIndex).sModes
            End Get
            Set(ByVal lValue As ModeModel)
        ...
        Public Property RealName(ByVal lIndex As Integer) As String
            Get
                ...
                Catch ex As Exception
                    Throw 'ProcessError(ex.Message, "Public Property RealName(ByVal lIndex As Integer) As String")
                    Return Nothing
                End Try
            End Get
            Set(ByVal lValue As String)
        ...
        Public Property Email(_StatusIndex As Integer) As String
            Get
                Try
                    ...
                    End With
                Catch ex As Exception
                    Throw 'ProcessError(ex.Message, "Public Property Email(_StatusIndex As Integer) As String")
                    Return Nothing
                End Try
            End Get
        ...
        Public Property NickName(_StatusIndex As Integer, Optional _SendToServer As Boolean = False) As String
            Get
                Try
                    ...
                    End With
                Catch ex As Exception
                    Throw 'ProcessError(ex.Message, "Public Property NickName(_StatusIndex As Integer) As String")
                    Return Nothing
                End Try
            End Get
        ...
        Public Sub UpdateCaption(_StatusIndex As Integer, _NickName As String, _Server As String)
            ...
            Catch ex As Exception
                Throw 'ProcessError(ex.Message, "Public Sub UpdateCaption(_StatusIndex As Integer, _NickName As String, _Server As String)")
            End Try
        End Sub
        Public Property StatusServerName(ByVal lIndex As Integer) As String
            Get
                ...
                Catch ex As Exception
                    Throw 'ProcessError(ex.Message, "Public Property StatusServerName(ByVal lIndex As Integer) As String")
                    Return Nothing
                End Try
            End Get
            Set(ByVal lValue As String)
        ...
        Public Property ActiveIndex() As Integer
            Get
                ...
                Catch ex As Exception
                    Throw 'ProcessError(ex.Message, "Public Property ActiveIndex() As Integer")
                    Return Nothing
                End Try
            End Get
        ...
        Public Property Pass(ByVal lIndex As Integer) As String
            Get
                ...
                Catch ex As Exception
                    Throw 'ProcessError(ex.Message, "Public ReadOnly Property Pass(ByVal lIndex As Integer) As String")
                    Return Nothing
                End Try
            End Get
            Set(ByVal lValue As String)
                ...
                Catch ex As Exception
                    Throw 'ProcessError(ex.Message, "Public Property Pass(ByVal lIndex As Integer) As String")
                End Try
            End Set
        End Property
        Public Property Closing() As Boolean
            Get
                Try
                    Return lClosing
                Catch ex As Exception
                    Throw 'ProcessError(ex.Message, "Public Property Closing() As Boolean")
                    Return Nothing
                End Try
            End Get
        ...
        Public ReadOnly Property Connected(_StatusIndex As Integer) As Boolean
            Get
                Try
                    ...
                    Return _Result
                Catch ex As Exception
                    Throw 'ProcessError(ex.Message, "Public Property Connected(_StatusIndex As Integer) As Boolean")
                    Return Nothing
                End Try
            End Get
        ...
        Public Sub ActiveStatusConnect()
            Try
                ...
                End With
            Catch ex As Exception
                Throw 'ProcessError(ex.Message, "Public Sub ActiveStatusConnect()")
            End Try
        End Sub
        Public Sub DoModes(ByVal _StatusIndex As Integer)
            Try
                'Dim msg As String, 
                Dim _Pluses As String = "", _Minuses As String = "", _Modes As String = "", m As ModeModel
                ...
                With m
                    ...
                    End If
                    If _Modes.Length <> 0 Then
                        If lSettings.lIRC.iSettings.sExtendedMessages = True Then lStrings.ProcessReplaceString(_StatusIndex, IrcNumeric.sSETTING_MODES)
                        SendSocket(_StatusIndex, "MODE " & NickName(_StatusIndex) & " " & _Modes)
                    End If
                End With
            Catch ex As Exception
                Throw 'ProcessError(ex.Message, "Public Sub DoModes(ByVal lStatusIndex As Integer)")
            End Try
        End Sub
        Public Sub AddText(ByVal _Data As String, ByVal _StatusIndex As Integer)
            ...
            If Len(_Data) <> 0 And _StatusIndex <> 0 Then
                With lStatusObjects.sStatusObject(_StatusIndex)
                    ...
                    .sWindow.txtIncoming.Print(_Data)
                End With
            End If
            'Catch ex As Exception
            'Throw
        ...
        Public Sub RemoveTreeView(ByVal lServerWindowIndex As Integer)
            Try
                ...
                End With
            Catch ex As Exception
                Throw 'ProcessError(ex.Message, "Public Sub RemoveTreeView(ByVal lServerIndex As Integer)")
            End Try
        End Sub
        ...
        Public ReadOnly Property NewInitialText(ByVal _Index As Integer) As String
            Get
                Return lSettings.lNetworks.Networks(lSettings.lServers.Servers(lSettings.lServers.Index).NetworkIndex).Name & " (" & Trim(_Index.ToString().Trim()) & ")"
            End Get
        End Property
                        ...
                        If n <> 0 Then
                            With lStatusObjects.sStatusObject(n)
                                If .sMotdWindow.mVisible = False Then
                                    ...
                                    .sMotdWindow.mWindow.FormType = FormTypes.MotdWindow
                        ...
                        If n <> 0 Then
                            With lStatusObjects.sStatusObject(n)
                                If .sUnknowns.uVisible = False Then
                                    ...
                                    .sUnknowns.uWindow.FormType = FormTypes.Unknown
                        ...
                        If n <> 0 Then
                            With lStatusObjects.sStatusObject(n)
                                If .sUnsupported.uVisible = False Then
                                    ...
                                    .sUnsupported.uWindow.FormType = FormTypes.Unsupported
                    ...
                    If LCase(lTreeNode.Text) = "notices" Then
                        ...
                        With lStatusObjects.sStatusObject(n).sNoticesWindow
                            If .nVisible = False Then
                                ...
                                .nWindow.FormType = FormTypes.NoticeWindow
        ...
        Public Sub ProcessWelcomeMessage(ByVal lStatusIndex As Integer, ByVal l001 As String, ByVal l002 As String, ByVal l003 As String, ByVal l004 As String)
            ...
            Catch ex As Exception
                Throw 'ProcessError(ex.Message, "Public Sub ProcessWelcomeMessage(ByVal l001 As String, ByVal l002 As String, ByVal l003 As String, ByVal l004 As String)")
            End Try
        End Sub
#End Region
#Region "PRIVATE MESSAGES"
        Public Sub PrivateMessage_ToggleWindowState(_StatusIndex As Integer, _PrivateMessageIndex As Integer)
            Try
                ...
                End If
            Catch ex As Exception
                Throw 'ProcessError(ex.Message, "Public Sub PrivateMessage_ToggleWindowState(_StatusIndex As Integer, _PrivateMessageIndex As Integer)")
            End Try
        End Sub
        Public Function PrivateMessage_Find(ByVal _StatusIndex As Integer, ByVal _Name As String) As Integer
            Try
                ...
                Return _Result
            Catch ex As Exception
                Throw 'ProcessError(ex.Message, "Public Function FindPrivateMessageIndex(ByVal _StatusIndex As Integer, ByVal _Name As String) As Integer")
                Return Nothing
            End Try
        End Function
            ...
            Try
                ...
                If (_NickName.Length <> 0) Then
                    ...
                    With lStatusObjects.sStatusObject(_StatusIndex).sPrivateMessages.pPrivateMessage(_PrivateMessageIndex)
                        ...
                        .pWindow.FormType = FormTypes.PrivateMessage
                ...
                End If
            Catch ex As Exception
                Throw 'ProcessError(ex.Message, "Public Sub PrivateMessage_Initialize(ByVal _StatusIndex As Integer, ByVal _NickName As String)")
            End Try
        End Sub
        ...
        Public Sub PrivateMessage_Add(statusIndex As Integer, name As String, host As String, data As String, Optional forceAllow As Boolean = False)
            ...
            Try
                ...
                If (Not forceAllow) Then
                    If (lSettings.lQuerySettings.AutoDeny = QueryOption.Everyone) Then ' Is the user on the auto deny list?
                        deny = True
                    ElseIf (lSettings.lQuerySettings.AutoDeny = QueryOption.List) Then
                        For i As Integer = 1 To lSettings.lQuerySettings.AutoDenyList.Count() - 1
                            If (privateMessageIndex <> 0) Then
                                If (Not String.IsNullOrEmpty(lStatusObjects.sStatusObject(statusIndex).sPrivateMessages.pPrivateMessage(privateMessageIndex).pName) And Not String.IsNullOrEmpty(lSettings.lQuerySettings.AutoDenyList(i))) Then
                                    If (lSettings.lQuerySettings.AutoDenyList(i).Trim().ToLower() = lStatusObjects.sStatusObject(statusIndex).sPrivateMessages.pPrivateMessage(privateMessageIndex).pName.Trim().ToLower()) Then
                        ...
                        Next i
                    End If
                    If (lSettings.lQuerySettings.AutoAllow = QueryOption.Everyone) Then ' Is the user on the auto allow list?
                        autoAllow = True
                    ElseIf (lSettings.lQuerySettings.AutoAllow = QueryOption.List) Then
                        For i As Integer = 1 To lSettings.lQuerySettings.AutoAllowList.Count() - 1
                            If (privateMessageIndex <> 0) Then
                                If ((Not String.IsNullOrEmpty(lSettings.lQuerySettings.AutoAllowList(i))) And (Not String.IsNullOrEmpty(lStatusObjects.sStatusObject(statusIndex).sPrivateMessages.pPrivateMessage(privateMessageIndex).pName))) Then
                                    If (lSettings.lQuerySettings.AutoAllowList(i).Trim().ToLower() = lStatusObjects.sStatusObject(statusIndex).sPrivateMessages.pPrivateMessage(privateMessageIndex).pName.Trim().ToLower()) Then
                                        autoAllow = True
                                        Exit For
                                    End If
                                End If
                ...
                Else
                    ...
                    deny = False
                End If
                If ((Not autoAllow) And (lSettings.lQuerySettings.EnableSpamFilter) And PrivateMessage_HasSpam(data)) Then Exit Sub ' If you're not auto allowing, if you have spam filter, check that data is spam free
                ...
                If (privateMessageIndex = 0) Then
                    ...
                    With lStatusObjects.sStatusObject(statusIndex).sPrivateMessages.pPrivateMessage(privateMessageIndex)
                        ...
                        If (autoAllow Or (Not lSettings.lQuerySettings.PromptUser)) Then
                            .pTreeNodeVisible = True
                            ...
                            If ((lSettings.lIRC.iSettings.sShowWindowsAutomatically = True) Or (forceAllow)) Then
                                .pWindow = New frmNoticeWindow()
                                .pWindow.FormType = FormTypes.PrivateMessage
                                .pWindow.lMdiWindow.Form_Load(FormTypes.PrivateMessage)
                                ...
                                If (Not String.IsNullOrEmpty(data)) Then .pWindow.DoNoticeColor(lStringsController.ReadReplacedString(IrcNumeric.sPRIVMSG, name, data))
                            End If
                        Else
        ...
        Public Sub PrivateMessage_SetListBox(ByVal _StatusIndex As Integer, ByVal _ListBox As ListBox)
            Try
                ...
                End With
            Catch ex As Exception
                Throw 'ProcessError(ex.Message, "Public Sub SetListBoxToPrivateMessages(ByVal lStatusIndex As Integer, ByVal lListBox As ListBox)")
            End Try
        End Sub
        Public Function PrivateMessage_HasSpam(ByVal lData As String) As Boolean
            Dim _Result As Boolean = False
            For _SpamPhraseIndex As Integer = 1 To lSettings.lQuerySettings.SpamPhrases.Count
                If InStr(LCase(lSettings.lQuerySettings.SpamPhrases(_SpamPhraseIndex)), LCase(lData)) <> 0 Then
                    _Result = True
                    Exit For
                End If
                ...
                Try
                    ...
                    With lStatusObjects.sStatusObject(_StatusIndex).sPrivateMessages.pPrivateMessage(_PrivateMessageIndex)
                        If (.pWindow Is Nothing) Then
                            ...
                            .pVisible = True
                            .pWindow.Show()
                            If (Not String.IsNullOrEmpty(.pFirstMessage)) Then .pWindow.DoNoticeColor(lStringsController.ReadReplacedString(IrcNumeric.sPRIVMSG, _Name, .pFirstMessage))
                            .pFirstMessage = ""
                            .pWindow.lMdiWindow.Form_Load(FormTypes.PrivateMessage)
                    ...
                    End With
                Catch ex As Exception
                    Throw 'ProcessError(ex.Message, "Public Property PrivateMessage_Visible(_StatusIndex As Integer, _Name As String) As Boolean")
                End Try
            End Set
        End Property
        Public Sub PrivateMessage_User(ByVal _StatusIndex As Integer, ByVal _UserName As String, ByVal _Data As String)
            Try
                ...
                End With
            Catch ex As Exception
                Throw 'ProcessError(ex.Message, "Public Sub PrivateMessage_User(ByVal _StatusIndex As Integer, ByVal _UserName As String, ByVal _Data As String)")
            End Try
        End Sub
#End Region
#Region "MOTD"
        Public Property Motd_Open(ByVal lIndex As Integer) As Boolean
            Get
                ...
                Catch ex As Exception
                    Throw 'ProcessError(ex.Message, "Public Property MotdClosed(ByVal lIndex As Integer) As Boolean")
                    Return Nothing
                End Try
            End Get
...
#Region "STATUS CONNECTION"
        ...
        Public Function Connect(ByVal _StatusIndex As Integer) As Boolean
            ...
            With lStatusObjects.sStatusObject(_StatusIndex)
                ...
                If (_StatusIndex <> 0 And .sPrimitives.sRemoteIP.Length() <> 0 And .sPrimitives.sRemotePort <> 0) Then
                    ...
                    .sWindow.Visible = True
                    lProcessNumeric.lIrcNumericHelper.ResetMessages()
                    If (lSettings.lIRC.iSettings.sExtendedMessages = True) Then lStrings.ProcessReplaceString(_StatusIndex, IrcNumeric.sATTEMPTING_CONNECTION, .sPrimitives.sRemoteIP, .sPrimitives.sRemotePort.ToString)
                    result = True
                Else
                    result = False
                ...
                End If
                If Err.Number <> 0 Then lStrings.ProcessReplaceString(_StatusIndex, IrcNumeric.sCONNECTION_DENIED)
            End With
            Return result
        End Function
        ...
        Public Sub Connect_Specify(ByVal _Server As String, ByVal _Port As Long)
            Try
                ...
                End If
            Catch ex As Exception
                Throw 'ProcessError(ex.Message, "Public Sub ConnectToGivenIRC(ByVal _Server As String, ByVal _Port As Long)")
            End Try
        End Sub
        Public Sub ConnectEvent(ByVal _Index As Integer)
            Try
                ...
                With lStatusObjects.sStatusObject(_Index)
                    .sConnecting = False
                    If lSettings.lIRC.iSettings.sExtendedMessages = True Then lStrings.ProcessReplaceString(_Index, IrcNumeric.sCONNECTION_ESTABLISHED)
                    If Len(lSettings.lIRC.iPass) <> 0 Then
                        If lSettings.lIRC.iSettings.sExtendedMessages = True Then lStrings.ProcessReplaceString(_Index, IrcNumeric.sSENDING_PASSWORD)
                        SendSocket(_Index, "PASS " & Pass(_Index))
                    Else
                        If lSettings.lIRC.iSettings.sExtendedMessages = True Then lStrings.ProcessReplaceString(_Index, IrcNumeric.sNOT_SENDING_PASSWORD)
                    End If
                    If Len(NickName(_Index)) <> 0 Then
                        lStrings.ProcessReplaceString(_Index, IrcNumeric.sSENDING_NICKNAME)
                        SendSocket(_Index, "NICK " & NickName(_Index))
                        If Len(Email(_Index)) <> 0 Then
                            msg = lStrings.LeftRight(Email(_Index), 0, InStr(Email(_Index), "@"))
                            If Len(msg) <> 0 Then
                                If lSettings.lIRC.iSettings.sExtendedMessages = True Then lStrings.ProcessReplaceString(_Index, IrcNumeric.sSENDING_LOGON_INFORMATION)
                ...
                End With
            Catch ex As Exception
                Throw 'ProcessError(ex.Message, "Public Sub ConnectEvent()")
            End Try
        End Sub
        Public Sub CloseStatusConnection(ByVal _StatusIndex As Integer, ByVal _CloseSocket As Boolean)
            Try
                With lStatusObjects.sStatusObject(_StatusIndex)
                    lStrings.ProcessReplaceString(_StatusIndex, IrcNumeric.sCONNECTION_CLOSED)
                ...
                End With
            Catch ex As Exception
                Throw 'ProcessError(ex.Message, "Public Sub CloseStatusConnection(ByVal _StatusIndex As Integer, ByVal _CloseSocket As Boolean)")
            End Try
        End Sub
        ...
        Public Sub NewStatusSocket(ByVal _Index As Integer)
            Try
                ...
                End With
            Catch ex As Exception
                Throw 'ProcessError(ex.Message, "Public Sub NewStatusSocket(ByVal lIndex As Integer)")
            End Try
        End Sub
        Public Sub SendSocket(ByVal _StatusIndex As Integer, ByVal _Data As String)
            Try
                ...
                End With
            Catch ex As Exception
                Throw 'ProcessError(ex.Message, "Public Sub SendSocket(ByVal _Index As Integer, ByVal _Data As String)")
            End Try
        End Sub
        Public Sub CloseSocket(ByVal _StatusIndex As Integer)
            Try
                ...
                End With
            Catch ex As Exception
                Throw 'ProcessError(ex.Message, "Public Sub CloseSocket(ByVal lIndex As Integer)")
            End Try
        End Sub
        Public Sub SetStatusConnecting(ByVal lIndex As Integer, ByVal lValue As Boolean)
            Try
                ...
                End With
            Catch ex As Exception
                Throw 'ProcessError(ex.Message, "Public Sub SetStatusConnecting(ByVal lIndex As Integer, ByVal lValue As Boolean)")
            End Try
        End Sub
        Public Function ReturnRemoteIP(ByVal lIndex As Integer) As String
            Try
                ...
                End With
            Catch ex As Exception
                Throw 'ProcessError(ex.Message, "Public Function ReturnRemoteIP(ByVal lIndex As Integer) As String")
                Return Nothing
            End Try
        End Function
...
#Region "NOTICES"
            ...
            Try
                        ...
                        With lStatusObjects.sStatusObject(lIndex)
                            ...
                            If .sNoticesWindow.nVisible = False Then
                                If lSettings.lIRC.iSettings.sShowWindowsAutomatically = True Then
                                    ...
                                    .sNoticesWindow.nWindow.FormType = FormTypes.PrivateMessage
                ...
                Else
                    If (lData2.Length <> 0) Then
                        lStrings.ProcessReplaceString(lIndex, IrcNumeric.sNOTICE, lData, lData2)
                    Else
                        lStrings.ProcessReplaceString(lIndex, IrcNumeric.sNOTICE, lData)
                    End If
                End If
            Catch ex As Exception
                Throw 'ProcessError(ex.Message, "Public Sub AddToNotices(ByVal lIndex As Integer, ByVal lData As String)")
            End Try
        End Sub
        Public Sub Form_Closing(Optional ByRef _Form As Form = Nothing, Optional ByRef _MeIndex As Integer = 0, Optional ByRef e As System.Windows.Forms.FormClosingEventArgs = Nothing)
            Try
                ...
                Exit Sub
            Catch ex As Exception
                Throw 'ProcessError(ex.Message, "Public Sub Form_Closing(_Form As Form)")
            End Try
        End Sub
        Public Property Notice_Visible(_StatusIndex As Integer) As Boolean
            Get
                Try
                    ...
                    End With
                Catch ex As Exception
                    Throw 'ProcessError(ex.Message, "Public Property Notice_Visible(_NoticeIndex As Integer) As Boolean")
                    Return Nothing
                End Try
            End Get
            Set(_Visible As Boolean)
        ...
        Public Sub AddToNotifyList(ByVal lStatusIndex As Integer, ByVal lNickName As String)
            Try
                ...
                End If
            Catch ex As Exception
                Throw 'ProcessError(ex.Message, "Public Sub AddToNotifyList(ByVal lStatusIndex As Integer, ByVal lNickName As String)")
            End Try
        End Sub
...
#Region "RAW"
                ...
                If lInData = True Then
                    With lStatusObjects.sStatusObject(lIndex).sRaw
                        ...
                        If .rVisible = False Then
                            ...
                            End If
                        Else
                            .rRawWindow.txtInData.AppendText(lData)
                        End If
                    End With
                Else
                    With lStatusObjects.sStatusObject(lIndex).sRaw
                        ...
                        If .rVisible = False Then
                            ...
                            End If
                        Else
                            .rRawWindow.txtOutData.AppendText(lData)
                        End If
                    End With
                End If
            End If
            'If Err.Number <> 0 Then Throw 'ProcessError(ex.Message, "Public Function ReturnChannelCount() As Integer")
        End Sub
        Public Sub SetRawData(ByVal lIndex As Integer, ByVal lInData As String, ByVal lOutData As String)
            ...
            With lStatusObjects.sStatusObject(lIndex).sRaw
                ...
                .rOutData = lOutData
            End With
            'If Err.Number <> 0 Then Throw 'ProcessError(ex.Message, "Public Sub SetRawData(ByVal lInData As String, ByVal lOutData As String)")
        End Sub
        Public Sub SetRawWindowClosed(ByVal lIndex As Integer)
            ...
            With lStatusObjects.sStatusObject(lIndex)
                ...
                .sRaw.rRawWindow = Nothing
            End With
            'If Err.Number <> 0 Then Throw 'ProcessError(ex.Message, "Public Sub SetRawWindowClosed(ByVal lIndex As Integer)")
        End Sub
#End Region
#Region "SERVER LINKS"
        Public Sub AddToServerLinks(ByVal lIndex As Integer, ByVal lServerIP As String, ByVal lServerPort As String)
            ...
            If Len(lServerIP) <> 0 And Len(lServerPort) <> 0 Then
                ...
                End With
            End If
            'If Err.Number <> 0 Then Throw 'ProcessError(ex.Message, "Public Sub AddToServerLinks(ByVal lServerIP As String, ByVal lServerPort As String)")
        End Sub
        Public Sub SetLinksWindowsVisible(ByVal lIndex As Integer, ByVal lValue As Boolean)
            ...
            End With
            'If Err.Number <> 0 Then Throw 'ProcessError(ex.Message, "Public Sub SetLinksWindowsVisible(ByVal lValue As Boolean)")
        End Sub
        ...
        Public Sub ClearServerLinks(ByVal lIndex As Integer)
            ...
            With lStatusObjects.sStatusObject(lIndex).sServerLinks
                ...
                .sLinkCount = 0
            End With
            'If Err.Number <> 0 Then Throw 'ProcessError(ex.Message, "Public Sub ClearServerLinks(ByVal lIndex As Integer)")
        End Sub
#End Region
#Region "UNKNOWNS"
        Public Sub SetUnknownsData(ByVal lStatusIndex As Integer, ByVal lData As String)
            ...
            End With
            'If Err.Number <> 0 Then Throw 'ProcessError(ex.Message, "Public Sub SetUnknownsData(ByVal lStatusIndex As Integer)")
        End Sub
        ...
        Public Sub SetUnknownsClosed(ByVal lStatusIndex As Integer)
            Try
                ...
                End With
            Catch ex As Exception
                Throw 'ProcessError(ex.Message, "Public Sub SetUnknownsClosed(ByVal lStatusIndex As Integer)")
            End Try
        End Sub
#End Region
#Region "UNSUPPORTED"
...
#Region "USER INPUT"
        Public Sub ProcessUserInput(ByVal _StatusIndex As Integer, ByVal _Data As String)
            Try
                ...
                If lStrings.DoLeft(_Data, 1) = "/" Then
                    ...
                    Select Case splt(0).Trim().ToLower()
                        Case "nick"
                            ...
                            For nickIndex As Integer = 1 To Modules.lSettings.lIRC.iNicks.nCount - 1
                                If (Modules.lSettings.lIRC.iNicks.nNick(nickIndex).nNick = splt(1)) Then
                                    ...
                                    lStrings.ProcessReplaceCommand(_StatusIndex, CommandTypes.cNICK, Modules.lSettings.lIRC.iNicks.nNick(nickIndex).nNick)
                                    Exit For
                                End If
                            Next nickIndex
                            Exit Sub
                        Case "echo"
                            ...
                            Exit Sub
                        Case "me"
                            Dim m As CommandReturnDataModel = lCommandController.ReadReplacedCommand(CommandTypes.cACTION, lChannels.Name(lChannels.CurrentIndex), Replace(_Data, "me", ""), Modules.lSettings.lIRC.iNicks.nNick(Modules.lSettings.lIRC.iNicks.nIndex).nNick)
                            lChannels.DoChannelColor(lChannels.CurrentIndex, m.DoColorData)
                            lStatus.SendSocket(_StatusIndex, m.SocketData)
                            Exit Sub
                        Case "whowas"
                            lStrings.ProcessReplaceCommand(_StatusIndex, CommandTypes.cWHOWAS, splt(1))
                            Exit Sub
                        Case "whois"
                            lStrings.ProcessReplaceCommand(_StatusIndex, CommandTypes.cWHOIS, splt(1))
                            Exit Sub
                        Case "who"
                            msg = Replace(LCase(_Data), "/who ", "")
                            msg = Replace(LCase(_Data), "who ", "")
                            lStrings.ProcessReplaceCommand(_StatusIndex, CommandTypes.cWHO, msg)
                            Exit Sub
                        Case "wallops"
                            msg = Replace(LCase(_Data), "/wallops ", "")
                            msg = Replace(LCase(_Data), "wallops ", "")
                            lStrings.ProcessReplaceCommand(_StatusIndex, CommandTypes.cWALLOPS, msg)
                        Case "version"
                            If UBound(splt) = 1 Then
                                lStrings.ProcessReplaceCommand(_StatusIndex, CommandTypes.cVERSION, splt(1))
                                Exit Sub
                            Else
                                lStrings.ProcessReplaceCommand(_StatusIndex, CommandTypes.cVERSION, "*")
                                Exit Sub
                            End If
                        Case "userhost"
                            lStrings.ProcessReplaceCommand(_StatusIndex, CommandTypes.cUSERHOST, splt(1))
                            Exit Sub
                        Case "trace"
                            lStrings.ProcessReplaceCommand(_StatusIndex, CommandTypes.cTRACE, splt(1))
                            Exit Sub
                        Case "topic"
                            lStrings.ProcessReplaceCommand(_StatusIndex, CommandTypes.cTOPIC, splt(1))
                            Exit Sub
                        Case "time"
                            If UBound(splt) = 1 Then
                                lStrings.ProcessReplaceCommand(_StatusIndex, CommandTypes.cTIME, splt(1))
                                Exit Sub
                            Else
                                lStrings.ProcessReplaceCommand(_StatusIndex, CommandTypes.cTIME, "*")
                                Exit Sub
                            End If
                        Case "stats"
                            lStrings.ProcessReplaceCommand(_StatusIndex, CommandTypes.cSTATS, splt(1))
                            Exit Sub
                        Case "squit"
                            lStrings.ProcessReplaceCommand(_StatusIndex, CommandTypes.cQUIT, splt(1), splt(2), splt(3), splt(4))
                            Exit Sub
                        Case "silence"
                            lStrings.ProcessReplaceCommand(_StatusIndex, CommandTypes.cSTATS, splt(1))
                            Exit Sub
                        Case "quit"
                            If UBound(splt) = 0 Then
                                If Len(lSettings.lIRC.iSettings.sQuitMessage) <> 0 Then
                                    lStrings.ProcessReplaceCommand(_StatusIndex, CommandTypes.cQUIT, lSettings.lIRC.iSettings.sQuitMessage)
                                Else
                                    lStrings.ProcessReplaceCommand(_StatusIndex, CommandTypes.cQUIT, "Quit")
                                End If
                                Exit Sub
                            Else
                                lStrings.ProcessReplaceCommand(_StatusIndex, CommandTypes.cQUIT, splt(1))
                                Exit Sub
                            End If
                            'Case "privmsg"
                            'Exit Sub
                        ...
                        Case "msg", "privmsg"
                            ...
                            lStrings.ProcessReplaceCommand(_StatusIndex, CommandTypes.cPRIVMSG, splt(1), splt(2))
                            Exit Sub
                        Case "processdata"
                        ...
                        Case "server"
                            If InStr(splt(1), ":") <> 0 Then
                                splt2 = Split(splt(1), ":")
                                Connect_Specify(splt2(0), splt2(1).ToLong)
                            Else
                ...
                End If
            Catch ex As Exception
                Throw 'ProcessError(ex.Message, "Public Sub ProcessUserInput(ByVal _StatusIndex As Integer, ByVal _Data As String, ByVal lTextBox As Object)")
            End Try
        End Sub
#End Region
#Region "TIMERS"
        Public Property TimerWaitForWhoisEnabled(ByVal lIndex As Integer) As Boolean
            Get
                ...
                Catch ex As Exception
                    Throw 'ProcessError(ex.Message, "Public Property TimerWaitForWhoisEnabled(ByVal lIndex As Integer) As Boolean")
                    Return Nothing
                End Try
            End Get
        ...
        Public Property TimerWaitForLUsersEnabled(ByVal lIndex As Integer) As Boolean
            Get
                ...
                Catch ex As Exception
                    Throw 'ProcessError(ex.Message, "Public Property TimerWaitForLUsersEnabled(ByVal lIndex As Integer) As Boolean")
                    Return Nothing
                End Try
            End Get
            Set(ByVal lValue As Boolean)
