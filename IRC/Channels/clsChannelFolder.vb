...
Public Class clsChannelFolderWindow
    ...
    Public Sub Form_Load(_Form As Form, _NetworksComboBox As RadDropDownList, _PopupOnConnectCheckBox As RadCheckBox, _AutoCloseCheckBox As RadCheckBox)
        ...
        '_Form.Left = CInt(Trim(ReadINI(lINI.iChannelFolders, "Settings", "Left", "300")))
        '_Form.Top = CInt(Trim(ReadINI(lINI.iChannelFolders, "Settings", "Top", "300")))
        'Catch ex As Exception
    ...
    Public Sub Form_FormClosed(_PopupOnConnect As Boolean, _AutoClose As Boolean, _Left As Integer, _Top As Integer)
        ...
        'WriteINI(lINI.iChannelFolders, "Settings", "Left", _Left.ToString())
        'WriteINI(lINI.iChannelFolders, "Settings", "Top", _Top.ToString())
        'Catch ex As Exception
...
Public Class clsChannelFolder
    ...
    Public Sub ShowWindow()
        ...
        'lWindow.Left = CInt(Trim(ReadINI(lINI.iChannelFolders, "Settings", "Left", "300")))
        'lWindow.Top = CInt(Trim(ReadINI(lINI.iChannelFolders, "Settings", "Top", "300")))
