...
#Region "STRUCTURES"
        Public Structure gLinks
            ...
            Public TreeNodeVisible As Boolean
            Public Visible As Boolean
            Public Window As frmServerLinks
            Public Links() As gLink
...
#Region "STATUS"
        ...
        Public Sub Clear(ByVal _StatusIndex As Integer)
            ...
            With lStatusObjects.sStatusObject(_StatusIndex)
                ...
                If .sServerLinks.Visible = True Then .sServerLinks.Window.Close()
                If .sServerLinks.TreeNodeVisible = True Then .sServerLinks.TreeNode = Nothing
                .sServerLinks.TreeNodeVisible = False
                .sServerLinks.Window = Nothing
                .sServerLinks.LinkCount = 0
                .sServerLinks.Links = Nothing
                .sServerLinks.Visible = False
                .sTreeNode = Nothing
        ...
        Public Function Create(ByVal lIRCSettings As IrcSettings, ByVal lServerSettings As gServers) As Integer
            ...
            With lStatusObjects.sStatusObject(i)
                ...
                'ReDim .sServerLinks.Links(Modules.lSettings.lArraySizes.aServerLinks)
        ...
        Public Sub DblClickConnections(ByVal lTreeNode As TreeNode)
            ...
            If lTreeNode IsNot Nothing Then
                ...
                If LCase(lTreeNode.Text) = "links" Then
                    ...
                    If n <> 0 Then
                        With lStatusObjects.sStatusObject(n)
                            If .sServerLinks.Visible = False Then
                                t = NetworkIndex(.sWindow.mdiChildWindow.MeIndex)
                                .sServerLinks.Visible = True
                                .sServerLinks.Window = New frmServerLinks
                                .sServerLinks.Window.Show()
                                .sServerLinks.Window.lServerLinksUI.SetStatusIndex(n)
                                .sServerLinks.Window.lServerLinksUI.SetNetworkIndex(t, .sServerLinks.Window.cboNetworks)
                                .sServerLinks.Window.cboNetworks.Text = Modules.IrcSettings.IrcNetworks.GetById(t).Description
                                For i = 1 To .sServerLinks.LinkCount
                                    .sServerLinks.Window.lServerLinksUI.AddToLinks(.sServerLinks.Links(i).ServerIP, .sServerLinks.Links(i).Port, .sServerLinks.Window.lvwLinks)
                                Next i
                            Else
                                mdiMain.SetWindowFocus(.sServerLinks.Window)
                            End If
                        End With
                    End If
                End If
...
#Region "SERVER LINKS"
        Public Sub AddToServerLinks(ByVal lIndex As Integer, ByVal lServerIP As String, ByVal lServerPort As String)
            ...
            If Len(lServerIP) <> 0 And Len(lServerPort) <> 0 Then
                With lStatusObjects.sStatusObject(lIndex)
                    If .sServerLinks.TreeNodeVisible = False Then
                        .sTreeNode.Nodes.Add("Links", "Links", 3, 3)
                        .sServerLinks.TreeNodeVisible = True
                    End If
                    If .sServerLinks.Visible = False Then
                        If Modules.lSettings.lIRC.iSettings.sShowWindowsAutomatically = True Then
                            ...
                            .sServerLinks.Window.Show()
                            .sServerLinks.Window.lServerLinksUI.SetStatusIndex(lIndex)
                            .sServerLinks.Window.lServerLinksUI.SetNetworkIndex(i, .sServerLinks.Window.cboNetworks)
                            .sServerLinks.Window.Text = "nexIRC " & StatusServerName(.sWindow.mdiChildWindow.MeIndex) & " - Links"
                        Else
                            If .sServerLinks.TreeNode.ImageIndex <> 6 Then .sServerLinks.TreeNode.ImageIndex = 6
                            If .sServerLinks.TreeNode.SelectedImageIndex <> 6 Then .sServerLinks.TreeNode.SelectedImageIndex = 6
                            .sServerLinks.LinkCount = .sServerLinks.LinkCount + 1
                            .sServerLinks.Links(.sServerLinks.LinkCount).ServerIP = lServerIP
                            .sServerLinks.Links(.sServerLinks.LinkCount).Port = lServerPort
                        End If
                    End If
                    .sServerLinks.Window.lServerLinksUI.AddToLinks(lServerIP, lServerPort, .sServerLinks.Window.lvwLinks)
                End With
            End If
        End Sub
        Public Sub SetLinksWindowsVisible(ByVal lIndex As Integer, ByVal lValue As Boolean)
            With lStatusObjects.sStatusObject(lIndex)
                .sServerLinks.Visible = lValue
            End With
        End Sub
        Public Sub SaveServerLink(ByVal lIndex As Integer, ByVal lServerIP As String, ByVal lServerPort As String)
            With lStatusObjects.sStatusObject(lIndex).sServerLinks
                ...
                .Links(.LinkCount).ServerIP = lServerIP
                .Links(.LinkCount).Port = lServerPort
            End With
        End Sub
...
#Region "UNSUPPORTED"
        Public Sub AddToUnsupported(ByVal lStatusIndex As Integer, ByVal lData As String)
            With lStatusObjects.sStatusObject(lStatusIndex)
                If Modules.lSettings.lIRC.iSettings.sStringSettings.sUnsupported = UnsupportedIn.StatusWindow Then
                    AddText(lData, lStatusIndex)
                ElseIf Modules.lSettings.lIRC.iSettings.sStringSettings.sUnsupported = UnsupportedIn.OwnWindow Then
