...
Public Class clsSendNoticeUI
    ...
    Public WriteOnly Property StatusIndex() As Integer
        Set(_StatusIndex As Integer)
            ...
            Catch ex As Exception
                Throw 'ProcessError(ex.Message, "Public WriteOnly Property StatusIndex() As Integer")
            End Try
        End Set
    End Property
    ...
    Public Sub Form_Load(_Form As Form)
        ...
        Catch ex As Exception
            Throw 'ProcessError(ex.Message, "Private Sub frmPrivateMessage_Load(sender As System.Object, e As System.EventArgs) Handles MyBase.Load")
        End Try
    End Sub
End Class