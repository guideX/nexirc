...
Public Class clsListViewSorter
    Private lListView As RadListView
...
#Region "Header Sort Icon"
    ...
    Public Property ListViewRef() As RadListView
        Get
            Return lListView
        End Get
        Set(ByVal Value As RadListView)
            lListView = Value
        End Set
    End Property
    ...
    Private Sub SetHeaderImageList(ByVal l As RadListView, ByVal lImageList As ImageList)
...
#End Region
    ...
    Public Sub New(ByVal lLV As RadListView)
        Try
            lInitialColumn = 0
...
Friend Class ColumnSorter
    ...
    Private Function DetectColumnType() As ColumnType
        Dim i As Integer, n As Integer, t As Integer, lItem As RadListViewItem, msg As String
        t = olvs.Column
        Try
