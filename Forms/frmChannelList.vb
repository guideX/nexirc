...
Public Class frmChannelList
    ...
    Private Sub frmChannelList_FormClosed(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosedEventArgs) Handles Me.FormClosed
        Try
            clsFiles.WriteINI(lINI.iIRC, "ChannelList", "Left", Me.Left.ToString)
            clsFiles.WriteINI(lINI.iIRC, "ChannelList", "Top", Me.Top.ToString)
            clsFiles.WriteINI(lINI.iIRC, "ChannelList", "Width", Me.Width.ToString)
            clsFiles.WriteINI(lINI.iIRC, "ChannelList", "Height", Me.Height.ToString)
            For i As Integer = 1 To 3
                clsFiles.WriteINI(lINI.iIRC, "lvwChannels_ColumnWidth", i.ToString, Me.lvwChannels.Columns(i - 1).Width.ToString)
            Next i
    ...
    Public Sub ResetList()
        Try
            ...
            lvwChannels.Columns.Add("Channel", CInt(Trim(clsFiles.ReadINI(lINI.iIRC, "lvwChannels_ColumnWidth", "1", "150"))), HorizontalAlignment.Left)
            lvwChannels.Columns.Add("Topic", CInt(Trim(clsFiles.ReadINI(lINI.iIRC, "lvwChannels_ColumnWidth", "2", "350"))), HorizontalAlignment.Left)
            lvwChannels.Columns.Add("Users", CInt(Trim(clsFiles.ReadINI(lINI.iIRC, "lvwChannels_ColumnWidth", "3", "100"))), HorizontalAlignment.Left)
        Catch ex As Exception
    ...
    Private Sub frmChannelList_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Try
            Me.Left = CInt(Trim(clsFiles.ReadINI(lINI.iIRC, "ChannelList", "Left", "300")))
            Me.Top = CInt(Trim(clsFiles.ReadINI(lINI.iIRC, "ChannelList", "Top", "300")))
            Me.Width = CInt(Trim(clsFiles.ReadINI(lINI.iIRC, "ChannelList", "Width", "300")))
            Me.Height = CInt(Trim(clsFiles.ReadINI(lINI.iIRC, "ChannelList", "Height", "300")))
