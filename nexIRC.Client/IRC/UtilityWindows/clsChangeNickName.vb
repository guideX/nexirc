    ...
    Public Class clsChangeNickName
        ...
        Public Sub Form_Load(_RadListBox As RadListControl)
            ...
            Catch ex As Exception
                Throw 'ProcessError(ex.Message, "Private Sub Form_Load()")
            End Try
        End Sub
        Public Sub lstNickNames_DoubleClick(_NickName As String, _Form As Form)
            ...
            Catch ex As Exception
                Throw 'ProcessError(ex.Message, "Private Sub lstNickNames_DoubleClick(sender As Object, e As System.EventArgs) Handles lstNickNames.DoubleClick")
            End Try
        End Sub
        Public Sub lstNickNames_SelectedIndexChanged(_NickName As String, _NickNameTextBox As RadTextBox)
            ...
            Catch ex As Exception
                Throw 'ProcessError(ex.Message, "Private Sub lstNickNames_SelectedIndexChanged(_NickName As String, _NickNameTextBox As RadTextBox)")
            End Try
        End Sub
        Public Sub cmdOK_Click(_NickName As String, _Form As Form)
            Try
                ...
                End If
            Catch ex As Exception
                Throw 'ProcessError(ex.Message, "Private Sub cmdOK_Click(sender As System.Object, e As System.EventArgs) Handles cmdOK.Click")
            End Try
        End Sub
        Public Sub cmdCancel_Click(_Form As Form)
            Try
                _Form.Close()
            Catch ex As Exception
                Throw 'ProcessError(ex.Message, "Private Sub cmdCancel_Click(sender As System.Object, e As System.EventArgs) Handles cmdCancel.Click")
            End Try
        End Sub
    End Class
End Namespace