...
Public Class clsChannelList
    ...
    Public Function ReturnStatusIndex(_ChannelListIndex As Integer) As Integer
        ...
        'Catch ex As Exception
        'RaiseEvent ProcessError(ex.Message, "Public Function ReturnStatusIndex(_ChannelListIndex As Integer) As Integer")
        'Return Nothing
        'End Try
    End Function
    Public Sub NewChannelList(_StatusIndex As Integer)
        ...
        End If
        'Catch ex As Exception
        'RaiseEvent ProcessError(ex.Message, "Public Sub NewChannelList(_StatusIndex As Integer)")
        'End Try
    End Sub
    Public Sub Clear(_ChannelListIndex As Integer)
        ...
        End With
        'Catch ex As Exception
        'RaiseEvent ProcessError(ex.Message, "Public Sub ClearChannelListItems(lStatusIndex As Integer)")
        'End Try
    End Sub
    Public Sub Unload(_ChannelListIndex As Integer)
        ...
        End With
        'Catch ex As Exception
        'RaiseEvent ProcessError(ex.Message, "Public Shared Sub Unload(_ChannelList As gChannelList)")
        'End Try
    End Sub
    Public WriteOnly Property StatusDescription(_ChannelListIndex As Integer) As String
        Set(_StatusDescription As String)
            ...
            'Catch ex As Exception
            'RaiseEvent ProcessError(ex.Message, "Public WriteOnly Property StatusDescription() As String")
            'End Try
        End Set
    End Property
    Public Sub Display(_ChannelListIndex As Integer)
        ...
        End With
        'Catch ex As Exception
        'RaiseEvent ProcessError(ex.Message, "Public Shared Sub Display(_ChannelList As gChannelList, _StatusDescription As String)")
        'End Try
    End Sub
    ...
    Public Sub HideTreeNode(_ChannelListIndex As Integer)
        ...
        End With
        'Catch ex As Exception
        'RaiseEvent ProcessError(ex.Message, "Public Sub HideTreeNode(_ChannelListIndex As Integer)")
        'End Try
    End Sub
    Public Sub DoubleClick(_ChannelListIndex As Integer)
        ...
        End With
        'Catch ex As Exception
        'RaiseEvent ProcessError(ex.Message, "Public Sub DoubleClick()")
        'End Try
    End Sub
    Public Function DoesChannelExist(_ChannelListIndex As Integer, _Channel As String) As Boolean
        ...
        Return _Result
        'Catch ex As Exception
        'RaiseEvent ProcessError(ex.Message, "Public Function DoesChannelExist(_ChannelListIndex As Integer, _Channel As String) As Boolean")
        'End Try
    End Function
    Public Sub Add(_ChannelListIndex As Integer, ByVal _Data As String)
        ...
        End If
        'Catch ex As Exception
        'RaiseEvent ProcessError(ex.Message, "Public Sub ProcessChannelListItem(ByVal lStatusIndex As Integer, ByVal lData As String)")
        'End Try
    End Sub
    Public Sub SetOpen(_ChannelListIndex As Integer)
        ...
        'End With
        'Catch ex As Exception
        'RaiseEvent ProcessError(ex.Message, "Public Sub SetChannelListClosed(ByVal lIndex As Integer)")
        'End Try
    End Sub
