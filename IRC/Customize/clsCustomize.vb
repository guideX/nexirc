...
Namespace IRC.Customize
    Public Class clsCustomize
        ...
        Public Sub lstDCCIgnoreItems_MouseClick(_ListBox As RadListControl)
            ...
            Catch ex As Exception
                Throw 'ProcessError(ex.Message, "Private Sub lstDCCIgnoreItems_MouseClick(ByVal sender As Object, ByVal e As System.Windows.Forms.MouseEventArgs) Handles lstDCCIgnoreItems.MouseClick")
            End Try
        End Sub
        Public Sub cmdDCCIgnoreRemove_Click(_ListBox As RadListControl)
            Try
                ...
                End If
            Catch ex As Exception
                Throw 'ProcessError(ex.Message, "Private Sub cmdDCCIgnoreRemove_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdDCCIgnoreRemove.Click")
            End Try
        End Sub
        Public Sub cmdNetworkSettings_Click()
            ...
            Catch ex As Exception
                Throw 'ProcessError(ex.Message, "Private Sub cmdNetworkSettings_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdNetworkSettings.Click")
            End Try
        End Sub
        Public Sub cmdCompatibilityEnable_Click(_Name As String, _ListItem As ListViewDataItem)
            Try
                ...
                Next i
            Catch ex As Exception
                Throw 'ProcessError(ex.Message, "Public Sub cmdCompatibilityEnable_Click()")
            End Try
        End Sub
        Public Sub cmdCompatibilityDisable_Click(_Name As String, _ListItem As ListViewDataItem)
            Try
                ...
                Next i
            Catch ex As Exception
                Throw 'ProcessError(ex.Message, "Public Sub cmdCompatibilityDisable_Click()")
            End Try
        End Sub
        Public Sub cmdRemoveNotify_Click(_NotifyListView As RadListView)
            ...
            Catch ex As Exception
                Throw 'ProcessError(ex.Message, "Private Sub cmdRemoveNotify_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdRemoveNotify.Click")
            End Try
        End Sub
        Public Sub cmdEditIdentSettings_Click()
            ...
            Catch ex As Exception
                Throw 'ProcessError(ex.Message, "Private Sub cmdEditIdentSettings_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdEditIdentSettings.Click")
            End Try
        End Sub
        Public Sub cmdRemoveIgnoreExtension_Click(_ListBox As RadListControl)
            ...
            Catch ex As Exception
                Throw 'ProcessError(ex.Message, "Private Sub cmdRemoveIgnoreExtension_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdRemoveIgnoreExtension.Click")
            End Try
        End Sub
        Public Sub cmdAddIgnoreExtension_Click(_ListBox As RadListControl)
            Try
                ...
                End If
            Catch ex As Exception
                Throw 'ProcessError(ex.Message, "Private Sub cmdAddIgnoreExtension_Click_1(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdAddIgnoreExtension.Click")
            End Try
        End Sub
        Public Sub lstDCCIgnoreItems_Click(_Button As RadButton)
            ...
            Catch ex As Exception
                Throw 'ProcessError(ex.Message, "Private Sub lstDCCIgnoreItems_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles lstDCCIgnoreItems.Click")
            End Try
        End Sub
        Public Sub lstIgnoreExtensions_SelectedIndexChanged(_RemoveButton As RadButton)
            ...
            Catch ex As Exception
                Throw 'ProcessError(ex.Message, "Private Sub lstIgnoreExtensions_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles lstIgnoreExtensions.SelectedIndexChanged")
            End Try
        End Sub
        Public Sub lvwServers_DoubleClick(_CheckBox As RadCheckBox, _Form As Form)
            Try
                ...
                RaiseEvent Close()
            Catch ex As Exception
                Throw 'ProcessError(ex.Message, "Private Sub lvwServers_DoubleClick(sender As Object, e As System.EventArgs) Handles lvwServers.DoubleClick")
            End Try
        End Sub
        Public Sub lnkNetworkDelete_LinkClicked(_DropDownList As RadDropDownList)
            Try
                ...
                End If
            Catch ex As Exception
                Throw 'ProcessError(ex.Message, "Private Sub lnkNetworkDelete_LinkClicked(sender As System.Object, e As System.Windows.Forms.LinkLabelLinkClickedEventArgs) Handles lnkNetworkDelete.LinkClicked")
            End Try
        End Sub
        Public Sub lnkNetworkAdd_LinkClicked()
            ...
            Catch ex As Exception
                Throw 'ProcessError(ex.Message, "Private Sub lnkNetworkAdd_LinkClicked(sender As System.Object, e As System.Windows.Forms.LinkLabelLinkClickedEventArgs) Handles lnkNetworkAdd.LinkClicked")
            End Try
        End Sub
        Public Sub cmdServerEdit_Click(_ListView As RadListView)
            Try
                ...
                End If
            Catch ex As Exception
                Throw 'ProcessError(ex.Message, "Private Sub cmdServerEdit_Click(sender As System.Object, e As System.EventArgs) Handles cmdServerEdit.Click")
            End Try
        End Sub
        Public Sub cmdServerDelete_Click(_ListView As RadListView)
            Try
                ...
                Next _Item
            Catch ex As Exception
                Throw 'ProcessError(ex.Message, "Public Sub cmdServerDelete_Click()")
            End Try
        End Sub
        Public Sub cmdServerAdd_Click()
            ...
            Try
                ...
                f.Show()
            Catch ex As Exception
                Throw 'ProcessError(ex.Message, "Public Sub cmdServerAdd_Click()")
            End Try
        End Sub
        Public Sub UpdateSelectedServer(_ServerListView As RadListView, _Description As String, _Ip As String, _Port As String)
            Try
                ...
                End If
            Catch ex As Exception
                Throw 'ProcessError(ex.Message, "Public Sub UpdateSelectedServer(_ServerListView As ListView, _Description As String, Ip As String, _Port As String, _Network As String)")
            End Try
        End Sub
        Public Sub lvwNotify_SelectedIndexChanged(_NotifyListView As RadListView, _NotifyNickNameTextBox As RadTextBox, _NotifyMessageTextBox As RadTextBox, _NetworkNotifyDropDownList As RadDropDownList)
            Try
                ...
                Next i
            Catch ex As Exception
                Throw 'ProcessError(ex.Message, "Public Sub lvwNotify_SelectedIndexChanged(_NotifyListView As RadListView, _NotifyNickNameTextBox As RadTextBox, _NotifyMessageTextBox As RadTextBox, _NetworkNotify As RadTextBox, _NetworkNotifyDropDownList As RadDropDownList)")
            End Try
        End Sub
        Public Sub cmdEditString_Click(_StringsListView As RadListView)
            Try
                ...
                End If
            Catch ex As Exception
                Throw 'ProcessError(ex.Message, "Public Sub cmdEditString_Click()")
            End Try
        End Sub
        Public Sub cmdServersClear_Click(_Network As String, _RadListView As RadListView)
            Try
                ...
                End If
            Catch ex As Exception
                Throw 'ProcessError(ex.Message, "Private Sub cmdClearServers_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdClearServers.Click")
            End Try
        End Sub
        Public Sub cmdServersMove_Click(_Network As String, _Server As String)
            Try
                ...
                End With
            Catch ex As Exception
                Throw 'ProcessError(ex.Message, "Private Sub cmdServersMove_Click(sender As System.Object, e As System.EventArgs) Handles cmdServersMove.Click")
            End Try
        End Sub
        ...
        Public Function cmdOK_Click(_NewStatus As Boolean, _Form As Form) As Boolean
            ...
            Try
                ...
                Return _Result
            Catch ex As Exception
                Throw 'ProcessError(ex.Message, "Public Sub cmdOK_Click()")
                Return Nothing
            End Try
        End Function
        Public Sub cmdApplyNow_Click(_Form As Form)
            Try
                _Form.Close()
            Catch ex As Exception
                Throw 'ProcessError(ex.Message, "Public Sub cmdApplyNow_Click()")
            End Try
        End Sub
        Public Sub cmdCancelNow_Click(_Form As Form)
            Try
                _Form.Close()
            Catch ex As Exception
                Throw 'ProcessError(ex.Message, "Public Sub cmdCancelNow_Click()")
            End Try
        End Sub
        Public Sub cboNetworks_SelectedIndexChanged(_Network As String, _ServersListView As RadListView)
            ...
            Catch ex As Exception
                Throw 'ProcessError(ex.Message, "Public Sub cboNetworks_SelectedIndexChanged()")
            End Try
        End Sub
        Public Sub frmCustomize_FormClosed()
            ...
            Catch ex As Exception
                Throw 'ProcessError(ex.Message, "Public Sub frmCustomize_FormClosed()")
            End Try
        End Sub
        Public Sub cmdAddNickName_Click()
            ...
            Try
                ...
                _AddNickName.Show()
            Catch ex As Exception
                Throw 'ProcessError(ex.Message, "Public Sub cmdAddNickName_Click(_NickName As String)")
            End Try
        End Sub
        Public Sub cmdRemoveNickName(_RadDropDownList As RadDropDownList)
            ...
            Catch ex As Exception
                Throw 'ProcessError(ex.Message, "Private Sub cmdRemove_Click(sender As System.Object, e As System.EventArgs)")
            End Try
        End Sub
        Public Sub cmdClearMyNickName_Click(_RadDropDownList As RadDropDownList)
            ...
            Catch ex As Exception
                Throw 'ProcessError(ex.Message, "Private Sub cmdClearMyNickName_Click(sender As System.Object, e As System.EventArgs) Handles cmdClearMyNickName.Click")
            End Try
        End Sub
        Public Sub cmdQuerySettings_Click()
            ...
            Try
                ...
                _QuerySettings.Show()
            Catch ex As Exception
                Throw 'ProcessError(ex.Message, "Public Sub cmdQuerySettings_Click()")
            End Try
        End Sub
        Public Sub cmdClearNotify_Click(_NotifyListView As RadListView)
            ...
            Catch ex As Exception
                Throw 'ProcessError(ex.Message, "Public Sub cmdClearNotify_Click()")
            End Try
        End Sub
        Public Sub cmdNotifyAdd_Click(_NotifyListView As RadListView)
            ...
            Catch ex As Exception
                Throw 'ProcessError(ex.Message, "Private Sub cmdAddNotify_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdAddNotify.Click")
            End Try
        End Sub
        Public Sub lnkAddServer_Click(_Network As String)
            ...
            Try
                ...
                End If
            Catch ex As Exception
                Throw 'ProcessError(ex.Message, "Public Sub lnkAddServer_Click(_NetworksDropDownList As RadDropDownList)")
            End Try
        End Sub
        Public Sub lnkNetworkAdd_Click()
            ...
            Catch ex As Exception
                Throw 'ProcessError(ex.Message, "Private Sub lnkNetworkAdd_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdAddNetwork.Click")
            End Try
        End Sub
        Public Sub Form_Load(_Form As Form, _CancelButton As RadButton, _ServersListView As RadListView)
            ...
            Catch ex As Exception
                Throw 'ProcessError(ex.Message, "Public Sub Form_Load(_Form As Form, _CancelButton As RadButton, _ServersListView As RadListView)")
            End Try
        End Sub
        Public Sub AddToNotifyListView(ByVal lNickName As String, ByVal lMessage As String, ByVal lServerIP As String, _RadListView As RadListView)
            Try
                ...
                End If
            Catch ex As Exception
                Throw 'ProcessError(ex.Message, "Private Sub AddToNotifyListView(ByVal lNickName As String, ByVal lMessage As String)")
            End Try
        End Sub
        Public Sub ClearServers(_RadListView As RadListView)
            Try
                _RadListView.Items.Clear()
            Catch ex As Exception
                Throw 'ProcessError(ex.Message, "Public Sub ClearServers(_RadListView As ListView)")
            End Try
        End Sub
        Public Sub RefreshNetworks(_RadDropDownList As RadDropDownList)
            Try
                ...
                Next i
            Catch ex As Exception
                Throw 'ProcessError(ex.Message, "Public Sub RefreshNetworks()")
            End Try
        End Sub
        Public Sub RefreshServers(_RadListView As RadListView, _NetworkIndex As Integer)
            Try
                ...
                End If
            Catch ex As Exception
                Throw 'ProcessError(ex.Message, "Public Sub RefreshServers(ByVal lFirstLoad As Boolean)")
            End Try
        End Sub
        Public Sub txtNotifyNetwork_TextChanged(_NotifyNetwork As String, _NotifyListView As RadListView)
            Try
                ...
                End If
            Catch ex As Exception
                Throw 'ProcessError(ex.Message, "Public Sub txtNotifyNetwork_TextChanged(_NotifyNetwork As String, _NotifyListView As RadListView)")
            End Try
        End Sub
        Public Sub txtNotifyMessage_TextChanged(_NotifyMessage As String, _NotifyListView As RadListView)
            Try
                ...
                End If
            Catch ex As Exception
                Throw 'ProcessError(ex.Message, "Public Sub txtNotifyMessage_TextChanged(_NotifyMessage As String, _NotifyListView As RadListView)")
            End Try
        End Sub
        Public Sub Apply_Settings_Servers(_ServersListView As RadListView, _SelectedNetwork As String)
            Try
                ...
                End If
            Catch ex As Exception
                Throw 'ProcessError(ex.Message, "Public Sub Apply_Servers(_ServersListView As RadListView, _NetworksDropDown As RadDropDownList)")
            End Try
        End Sub
        Public Sub Apply_Settings_Startup(
            ...
            Try
                ...
                End With
            Catch ex As Exception
                Throw 'ProcessError(ex.Message, "Public Sub Apply_Settings_Startup")
            End Try
        End Sub
        ...
        Public Sub Apply_Settings_IRC(
            ...
            Try
                ...
                End With
            Catch ex As Exception
                Throw 'ProcessError(ex.Message, "Public Sub Apply_Settings_IRC")
            End Try
        End Sub
        Public Sub Apply_Settings_ServerModes(
            ...
            Try
                ...
                End With
            Catch ex As Exception
                Throw 'ProcessError(ex.Message, "Public Sub Apply_Settings_ServerModes()")
            End Try
        End Sub
        ...
        Public Sub Apply_Settings_DCC(_DccChatPrompt As Boolean,
            ...
            Catch ex As Exception
                Throw 'ProcessError(ex.Message, "Public Sub Apply_Settings_DCC()")
            End Try
        End Sub
        Public Sub Apply_Settings_User(_NickNamesDropDownList As RadDropDownList, _HomePage As String, _UserEmail As String, _Password As String, _RealName As String, _OperName As String, _OperPassword As String)
            Try
                ...
                End With
            Catch ex As Exception
                Throw 'ProcessError(ex.Message, "Public Sub Apply_User(_NickNamesDropDownList As RadDropDownList, _HomePage As String)")
            End Try
        End Sub
        Public Sub txtNotifyNickname_TextChanged(_NotifyNickName As String, _NotifyListView As RadListView)
            Try
                ...
                End If
            Catch ex As Exception
                Throw 'ProcessError(ex.Message, "Public Sub txtNotifyNickname_TextChanged(_NotifyNickNameTextBox As RadTextBox, _NotifyListView As ListView)")
            End Try
        End Sub
    End Class
End Namespace