...
Public Class clsFlashWindow
    ...
    Private Sub lTimer_Tick(ByVal sender As Object, ByVal e As System.EventArgs) Handles lTimer.Tick
        ...
        ''RaiseEvent ProcessError(ex.Message, "Private Sub lTimer_Tick(ByVal sender As Object, ByVal e As System.EventArgs) Handles lTimer.Tick")
        ''End Try
    End Sub
    ...
    Public Sub FlashOnce()
        ...
        ''Catch ex As Exception
        ''RaiseEvent ProcessError(ex.Message, "Public Sub FlashOnce()")
        ''End Try
    End Sub
    ...
    Public Sub EnableDisableTimer(Optional ByVal _Enabled As Boolean = True, Optional ByVal _Interval As Integer = 300)
        ...
        End If
        ''Catch ex As Exception
        ''RaiseEvent ProcessError(ex.Message, "Public Sub Start()")
        ''End Try
    End Sub
