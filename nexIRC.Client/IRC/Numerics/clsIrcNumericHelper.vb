    ...
    Public Class clsIrcNumericHelper
        ...
        Public Sub DCCChatProc(ByVal lStatusIndex As Integer, ByVal lData As String)
            Try
                ...
                If IsNickNameInDCCIgnoreList(Trim(msg)) = False Then
                    If Modules.lSettings_DCC.dChatPrompt = eDccPrompt.ePrompt Then
                        ...
                        lDCCChatPrompt.Show()
                    ElseIf Modules.lSettings_DCC.dChatPrompt = eDccPrompt.eAcceptAll Then
                        Dim lDCCChat As New frmDCCChat
                        lDCCChat.cboUsers.Text = Trim(msg)
                        lDCCChat.lDccChatUI.SetInfo(splt(6), Trim(splt(7)))
                        lDCCChat.Show()
                    ElseIf Modules.lSettings_DCC.dChatPrompt = eDccPrompt.eIgnore Then
                    End If
                End If
            Catch ex As Exception
                Throw ex
        ...
        Public Function ReturnIsFileTypeIgnored(ByVal fileName As String) As Boolean
            ...
            Try
                ...
                With Modules.lSettings_DCC.dIgnorelist
                    For i = 1 To .dCount
            ...
            Try
                ...
                If IsNickNameInDCCIgnoreList(msg) = False Then
                    If ReturnIsFileTypeIgnored(Trim(splt(5))) = False Then
                        If Modules.lSettings_DCC.dSendPrompt = eDccPrompt.ePrompt Then
                        ...
                        ElseIf Modules.lSettings_DCC.dSendPrompt = eDccPrompt.eAcceptAll Then
                            ...
                            lForm.Show()
                        ElseIf Modules.lSettings_DCC.dSendPrompt = eDccPrompt.eIgnore Then
        ...
        Public Sub ProcessDataArrival(ByVal lStatusIndex As Integer, ByVal lData As String)
            Try
                ...
                End If
            Catch ex As Exception
                Modules.lStrings.ProcessReplaceString(lStatusIndex, eStringTypes.sSOCKET_ERROR, ex.Message)
            End Try
        End Sub
