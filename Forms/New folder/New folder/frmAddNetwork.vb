...
Public Class frmAddNetwork
    Private Sub OK_Button()
        ...
        If Len(txtNetwork.Text) <> 0 Then
            AddNetwork(txtNetwork.Text)
            Me.Close()
        Else
    ...
    Private Sub frmAddNetwork_Load(ByVal sender As System.Object, ByVal e As System.EventArgs)
        On Error Resume Next
    ...
    Private Sub txtNetwork_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs)
        On Error Resume Next
        If e.KeyChar = Microsoft.VisualBasic.ChrW(Keys.Return) Then
            e.Handled = True
            OK_Button()
        End If
        'If Err.Number <> 0 Then ProcessError(ex.Message, "Private Sub txtNetwork_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles txtNetwork.KeyPress")
    End Sub
    ...
    Private Sub frmAddNetwork1_Load(sender As System.Object, e As System.EventArgs) Handles MyBase.Load
