...
Public Class frmDCCGet
    ...
    Public Sub InitDCCGet(ByVal lUsr As String, ByVal lRemIp As String, ByVal lRemPort As String, ByVal lFileName As String, ByVal lFileSize As String)
        ...
        Catch ex As Exception
            ProcessError(ex.Message, "Public Sub InitDCCGet(ByVal lUsr As String, ByVal lRemIp As String, ByVal lRemPort As String, ByVal lFileName As String, ByVal lFileSize As String)")
        End Try
    End Sub
    ...
    Private Sub frmDCCGet_FormClosed(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosedEventArgs) Handles Me.FormClosed
        ...
        Catch ex As Exception
            ProcessError(ex.Message, "Private Sub frmDCCGet_FormClosed(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosedEventArgs) Handles Me.FormClosed")
        End Try
    End Sub
    ...
    Private Sub SocketConnectedProc()
        Try
            ...
            lFileOpen = True
        Catch ex As Exception
            ProcessError(ex.Message, "Private Sub SocketConnectedProc()")
        End Try
    End Sub
    ...
    Private Sub SocketDataArrivalProc(ByVal lData As String, ByVal lBytes() As Byte, ByVal lBytesRecieved As Integer)
        Try
            ...
            End If
        Catch ex As Exception
            ProcessError(ex.Message, "Private Sub SocketDataArrivalProc(ByVal lData As String)")
        End Try
    End Sub
    ...
    Private Sub EndTransfer()
        Try
            ...
            End If
        Catch ex As Exception
            ProcessError(ex.Message, "Private Sub EndTransfer()")
        End Try
    End Sub
    ...
    Private Function BytesToChars(ByVal lBytes As Long) As Byte()
        ...
        Catch ex As Exception
            ProcessError(ex.Message, "Private Function BytesToChars(ByVal lBytes As Long) As Byte()")
            Return Nothing
        End Try
    End Function
    ...
    Private Sub SocketDisconnectedProc()
        ...
        Catch ex As Exception
            ProcessError(ex.Message, "Private Sub SocketDisconnectedProc()")
        End Try
    End Sub
    ...
    Private Sub lSocket_socketConnected(ByVal SocketID As String) Handles lSocket.socketConnected
        ...
        Catch ex As Exception
            ProcessError(ex.Message, "Private Sub lSocket_socketConnected(ByVal SocketID As String) Handles lSocket.socketConnected")
        End Try
    End Sub
    ...
    Public Sub SetProgressBar(ByVal lProgressBar As ProgressBar, ByVal lPercent As Integer)
        ...
        Catch ex As Exception
            ProcessError(ex.Message, "Public Sub SetProgressBar(ByVal lProgressBar As ProgressBar, ByVal lPercent As Integer)")
        End Try
    End Sub
    ...
    Private Sub lSocket_socketDataArrival(ByVal SocketID As String, ByVal SocketData As String, ByVal lBytes() As Byte, ByVal lBytesRead As Integer) Handles lSocket.socketDataArrival
        ...
        Catch ex As Exception
            ProcessError(ex.Message, "Private Sub lSocket_socketDataArrival(ByVal SocketID As String, ByVal SocketData As String) Handles lSocket.socketDataArrival")
        End Try
    End Sub
    ...
    Private Sub lSocket_socketDisconnected(ByVal SocketID As String) Handles lSocket.socketDisconnected
        ...
        Catch ex As Exception
            ProcessError(ex.Message, "Private Sub lSocket_socketDisconnected(ByVal SocketID As String) Handles lSocket.socketDisconnected")
        End Try
    End Sub
    ...
    Private Sub tmrSendCurrentSize_Tick(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles tmrSendCurrentSize.Tick
        Try
            ...
            lSocket.SendBytes(BytesToChars(lBytesRecievedCount))
        Catch ex As Exception
            ProcessError(ex.Message, "Private Sub tmrSendCurrentSize_Tick(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles tmrSendCurrentSize.Tick")
        End Try
    End Sub
    ...
    Private Sub cmdDownloadTo_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdDownloadTo.Click
        ...
        Catch ex As Exception
            ProcessError(ex.Message, "Private Sub cmdSelectFile_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdSelectFile.Click")
        End Try
    End Sub
    ...
    Private Sub tmrDelayEndTransfer_Tick(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles tmrDelayEndTransfer.Tick
        Try
            ...
            End If
        Catch ex As Exception
            ProcessError(ex.Message, "Private Sub tmrDelayEndTransfer_Tick(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles tmrDelayEndTransfer.Tick")
        End Try
    End Sub
End Class