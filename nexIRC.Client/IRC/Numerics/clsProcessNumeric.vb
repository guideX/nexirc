...
Namespace nexIRC.Client.IRC.Numerics
    Public Class clsProcessNumeric
        ...
        Public Sub ProcessReplaceStringHelper(ByVal lStatusIndex As Integer, ByVal lType As eStringTypes, ByVal r1 As String)
            ...
            Catch ex As Exception
                Throw ex 'ProcessError(ex.Message, "Private Sub Modules.lStrings.ProcessReplaceStringHelper(ByVal lStatusIndex As Integer, ByVal lType As eStringTypes, ByVal r1 As String)")
            End Try
        End Sub
    End Class
End Namespace