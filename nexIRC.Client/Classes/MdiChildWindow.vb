    ...
    Public Class MdiChildWindow
        ...
        Public Sub cmdAddToChannelFolder_Click()
            Select Case _formType
                Case FormTypes.Channel
                    Modules.IrcSettings.ChannelFoldersRepository.Add(Modules.lChannels.Name(_meIndex), Modules.IrcSettings.IrcNetworks.GetById(Modules.lChannels.StatusIndex(_meIndex)).Description)
            End Select
        End Sub
        ...
        Public Sub cmdChangeNickName_Click()
            ...
            If (statusIndex <> 0) Then
                ...
                f.ChangeNickName.ServerIndex = _meIndex
                f.Show()
            End If
        End Sub
